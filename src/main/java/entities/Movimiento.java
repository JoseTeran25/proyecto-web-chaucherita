...
public class Movimiento implements Serializable {
	...
	public static boolean createGasto(Movimiento gasto) {
	    ...
	    try {
	        entityManager = Persistence.createEntityManagerFactory("persistencia").createEntityManager();
	        transaction = entityManager.getTransaction();
	        transaction.begin();
	        Cuenta cuenta = gasto.getOrigen();
	        if(cuenta.getTotal() < (gasto.getMonto())*-1) {
	        	System.out.println("Valor de cuenta menor al monto que se quiere retirar");
	        ...
	        //Disminuir el total de la cuenta 
	        
	        cuenta.setTotal(cuenta.getTotal() + gasto.getMonto());
	        ...
	        ex.printStackTrace(); // Manejo de la excepción, puedes cambiar esto según tu necesidad
	        return false;
	    } finally {
