...
<body>
  ...
  <header class="header_pagina_principal">
    ...
    <div class="seleccionar_cuenta">
      <iconify-icon class="icono" icon="mdi:credit-card" width="20"></iconify-icon>
      <select class="cuenta_seleccionada" onchange="location = this.value;">
        <option value="cuenta_banco.html">Banco</option>
        <option value="cuenta_efectivo.html">Efectivo</option>
        <option value="cuenta_tarjeta.html" selected>Tarjeta</option>
      </select>
    </div>
